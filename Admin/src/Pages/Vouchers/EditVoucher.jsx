...
const EditVoucher = () => {
    ...
    useEffect(() => {
        const fetchVoucher = async () => {
            try {
                const response = await axios.get(`https://ujjwalbackend.onrender.com/api/new-lanch/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.put(`https://ujjwalbackend.onrender.com/api/new-lanch/${id}`, data, {
                headers: {
